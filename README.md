...
![Platform](https://img.shields.io/badge/platform-Kaggle_GPU_T4-20BEFF)
![Parameters](https://img.shields.io/badge/parameters-~144k-lightgrey)
...
*\* Single-split estimate — high variance. CV mean would be lower.*
...
*CRNN v3 · Speech Emotion Detection · TensorFlow 2.x · Kaggle GPU T4 · 2026*